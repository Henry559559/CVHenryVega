...
let wordpress = document.getElementById("sql");
crearBarra(wordpress);
let photoshop = document.getElementById("phyton");
crearBarra(photoshop);
let php = document.getElementById("visual");
crearBarra(php);
let ilustrator = document.getElementById("visualmvc");
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalHtml = setInterval(function(){
            pintarBarra(java, 16, 0, intervalHtml);
        },100);
